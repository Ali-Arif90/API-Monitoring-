...
const config = {
    ...
    prediction: {
        intervalMs: parseInt(process.env.PREDICTION_INTERVAL_MS || '300000', 10),
        trainingIntervalMs: parseInt(process.env.MODEL_TRAINING_INTERVAL_MS || '3600000', 10),
        zScoreThreshold: parseFloat(process.env.ANOMALY_ZSCORE_THRESHOLD || '2.5'),
        downtimeAlertThreshold: parseFloat(process.env.DOWNTIME_ALERT_THRESHOLD || '0.7'),
        latencySlaMs: parseInt(process.env.LATENCY_SLA_MS || '500', 10),
    },
